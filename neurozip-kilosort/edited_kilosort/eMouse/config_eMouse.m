...
ops.spacing = 3; %NEED TO ALSO SET THIS IF LINSPACE OPTION IS SET
ops.batchFactor = 7.34; %if not using spacing, take numBatch/ops.batchFactor batches for template matching
ops.batchPCS = 3;
