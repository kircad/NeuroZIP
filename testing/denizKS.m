...
pathToYourConfigFile = 'C:\Users\kirca\Desktop\NeuroZIP\config'; % for this example it's ok to leave this path inside the repo, but for your own config file you *must* put it somewhere else!  
