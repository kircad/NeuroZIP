...
ops.spacing = -1; %take every n batches, -1 if random
ops.optimizeBatches = 0;
ops.batchFactor = 5; %if not using spacing, take numBatch/ops.batchFactor batches for template matching
